...
Call log:
  - Expect "toHaveURL" with timeout 5000ms
    13 × unexpected value "https://shop.mango.com/es/es/search/mujer"
...
- main:
  ...
  - list:
    - listitem:
      - link "Bolso shopper fibra natural detalle hebilla - Artículo sin modelo":
        - /url: https://shop.mango.com/es/es/p/mujer/bolsos/de-hombro/bolso-shopper-fibra-natural-detalle-hebilla/37061326/08/00
        - img "Bolso shopper fibra natural detalle hebilla - Artículo sin modelo"
      - group "Tallas":
        - text: Tallas
        - button "Talla única"
      - paragraph: Bolso shopper fibra natural detalle hebilla
      - button "Guardar como favorito":
        - img "Guardar como favorito"
      - text: Precio actual [69,99 € ]
    - listitem:
      - link "Vestido textura detalle fruncido - Artículo sin modelo":
        - /url: https://shop.mango.com/es/es/p/mujer/vestidos-y-monos/casual/vestido-textura-detalle-fruncido/37011381/99/00
        - img "Vestido textura detalle fruncido - Artículo sin modelo"
      - group "Tallas":
        - text: Tallas
        - button "XXS"
        - button "XS"
        ...
        - button "3XL"
        - button "4XL"
      - paragraph: Vestido textura detalle fruncido
      - button "Guardar como favorito":
        - img "Guardar como favorito"
      - text: Precio actual [39,99 € ]
    - listitem:
      - link "Top crochet lúrex volante festoneado - Artículo sin modelo":
        - /url: https://shop.mango.com/es/es/p/mujer/tops/fiesta/top-crochet-lurex-volante-festoneado/37061470/63/00
        - img "Top crochet lúrex volante festoneado - Artículo sin modelo"
      - group "Tallas":
        - text: Tallas
        - button "XXS"
        - button "XS"
        ...
        - button "XL"
        - button "XXL"
      - paragraph: Top crochet lúrex volante festoneado
      - button "Guardar como favorito":
        - img "Guardar como favorito"
      - text: Precio actual [29,99 € ]
    - listitem:
      - link "Bañador asimétrico aro - Artículo sin modelo":
        - /url: https://shop.mango.com/es/es/p/mujer/bikinis-y-banadores/banadores/banador-asimetrico-aro/27074411/30/00
        - img "Bañador asimétrico aro - Artículo sin modelo"
      - group "Tallas":
        - text: Tallas
        - button "XS"
        - button "S"
        ...
        - button "L"
        - button "XL"
      - paragraph: Bañador asimétrico aro
      - button "Guardar como favorito":
        - img "Guardar como favorito"
      - text: Precio actual [35,99 € ]
    - listitem:
      - link "Jeans balloon crop - Artículo sin modelo":
        - /url: https://shop.mango.com/es/es/p/mujer/vaqueros/balloon/jeans-balloon-crop/37051470/TM/00
        - img "Jeans balloon crop - Artículo sin modelo"
      - group "Tallas":
        - text: Tallas
        - button "32"
        - button "34"
        ...
        - button "44"
        - button "46"
      - paragraph: Jeans balloon crop
      - button "Guardar como favorito":
        - img "Guardar como favorito"
      - text: Precio actual [39,99 € ]
    - listitem:
      - link "Vestido satinado asimétrico - Artículo sin modelo":
        - /url: https://shop.mango.com/es/es/p/mujer/vestidos-y-monos/fiesta/vestido-satinado-asimetrico/37013869/70/00
        - img "Vestido satinado asimétrico - Artículo sin modelo"
      - group "Tallas":
        - text: Tallas
        - button "XS"
        - button "S"
        ...
        - button "XL"
        - button "XXL"
      - paragraph: Vestido satinado asimétrico
      - button "Guardar como favorito":
        - img "Guardar como favorito"
      - text: Precio actual [59,99 € ]
    - listitem:
